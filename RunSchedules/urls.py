...
urlpatterns = [
    ...
    url(r'^daily_training_delete/(?P<training_id>\d+)$', DailyTrainingDelete.as_view()),
    url(r'^daily_training_edit/(?P<plan_id>\d+)/(?P<training_id>\d+)$', DailyTrainingEdit.as_view()),
