...
urlpatterns = [
    ...
    url(r'^training_edit/(?P<plan_id>\d+)/(?P<training_id>\d+)$', TrainingEdit.as_view()),
    url(r'^training_edit/(?P<plan_id>\d+)/(?P<training_id>\d+)/(?P<month_number>\d+)$', TrainingEdit.as_view()),
