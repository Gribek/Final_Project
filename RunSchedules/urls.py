...
urlpatterns = [
    ...
    url(r'^workout/(?P<month_number_requested>\d+)$',
    ...
    url(r'^plan_details/(?P<plan_id>\d+)$', PlanDetailsView.as_view(),
        name='plan_details'),
    url(r'^training_add/(?P<plan_id>\d+)$', TrainingAdd.as_view(),
        name='add_training'),
    url(r'^training_add/(?P<plan_id>\d+)/(?P<month_number>\d+)$',
        TrainingAdd.as_view(), name='add_training_month'),
    url(r'^training_add/(?P<plan_id>\d+)/(?P<month_number>\d+)/(?P<date>.+)$',
    ...
    url(r'^training_edit/(?P<plan_id>\d+)/(?P<training_id>\d+)$',
        TrainingEdit.as_view(), name='edit_training'),
    url(r'^training_edit/(?P<plan_id>\d+)/(?P<training_id>\d+)/(?P<month_number>\d+)$',
