...
class PermissionRequiredViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        WorkoutPlan.objects.create(plan_name='setUp plan 2', date_range=["2011-01-01", "2018-01-31"], owner=user_2,
                                   is_active=False)
        WorkoutPlan.objects.create(plan_name='setUp plan 3', date_range=["2011-01-01", "2018-01-31"], owner=user_1)
        WorkoutPlan.objects.create(plan_name='setUp plan 4', date_range=["2011-01-01", "2018-01-31"], owner=user_1)
        WorkoutPlan.objects.create(plan_name='setUp plan 5', date_range=["2011-01-01", "2018-01-31"], owner=user_2)
